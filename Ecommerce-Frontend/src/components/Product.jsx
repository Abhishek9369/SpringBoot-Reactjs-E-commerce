...
const Product = () => {
  ...
  useEffect(() => {
    ...
    const fetchImage = async () => {
      const response = await axios.get(`${API_BASE}/api/product/${id}/image`, {
        responseType: "blob",
      });
        ...
        <div className="right-column" style={{ width: "50%" }}>
          ...
          <div className="product-price">
            ...
            <button
              ...
              style={{ padding: "1rem 2rem", fontSize: "1rem", backgroundColor: "#007bff", color: "white", border: "none", borderRadius: "5px", cursor: "pointer", marginBottom: "1rem" }}
            >
          ...
          <div className="update-button" style={{ display: "flex", gap: "1rem" }}>
            <button className="btn btn-primary" onClick={handleEditClick} style={{ padding: "1rem 2rem", fontSize: "1rem", backgroundColor: "#007bff", color: "white", border: "none", borderRadius: "5px", cursor: "pointer" }}>
              Update
            </button>
            <button className="btn btn-primary" onClick={deleteProduct} style={{ padding: "1rem 2rem", fontSize: "1rem", backgroundColor: "#dc3545", color: "white", border: "none", borderRadius: "5px", cursor: "pointer" }}>
              Delete
            </button>
          </div>
        </div>
